...
const LoginDialog = ({ open, setOpen, setAccount }) => {
    ...
    const loginUser = async() => {
        ...
        const mobileNumber = login.mobileNumber;
        const password = login.password;

        dispatch(userLogin({mobileNumber , password }))
    }

    const signupUser = async() => {
        
        const mobileNumber = signup.mobileNumber;
        ...
        dispatch(userSignUp({ mobileNumber,password }))
                ...
                <Box style={{display: 'flex'}}>
                    ...
                    </Box>
                    {
                        ...
                        <Box className={classes.login}>
                            <TextField onChange={(e) => onValueChange(e)} name='mobileNumber' label='Enter Email/Mobile number' />
                        ...
                        <Box className={classes.login}>
                            <TextField onChange={(e) => onInputChange(e)} name='mobileNumber' label='Enter Mobile Number' />
                            <TextField onChange={(e) => onInputChange(e)} name='password' label='Enter Password' />
                            { signUPerror && <Typography className={classes.error}>Please enter valid Mobile number/Password</Typography> }
                            <TextField onChange={(e) => onInputChange(e)} name='confirm_password' label='Enter Confirm Password' />
